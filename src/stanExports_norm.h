...
namespace model_norm_namespace {
using std::istream;
using std::string;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_norm_namespace::model_norm";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_norm_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_norm_namespace::model_norm stan_model;
#endif
