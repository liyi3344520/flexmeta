...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_jf");
    reader.add_event(51, 49, "end", "model_jf");
    return reader;
}
...
tbeta(const T0__& a,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(((stan::math::tgamma(a) * stan::math::tgamma(b)) / stan::math::tgamma((a + b))));
...
jf_lpdf(const T0__& y,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>((((((-(stan::math::log(omega)) - (((a + b) - 1) * stan::math::log(2))) - (0.5 * stan::math::log((a + b)))) - stan::math::log(tbeta(a, b, pstream__))) + ((a + 0.5) * stan::math::log((1 + ((y - xi) / (omega * stan::math::sqrt(((a + b) + (((y - xi) * (y - xi)) / (omega * omega)))))))))) + ((b + 0.5) * stan::math::log((1 - ((y - xi) / (omega * stan::math::sqrt(((a + b) + (((y - xi) * (y - xi)) / (omega * omega)))))))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
jf_lpdf(const T0__& y,
            ...
            const T3__& a,
            const T4__& b, std::ostream* pstream__) {
    return jf_lpdf<false>(y,xi,omega,a,b, pstream__);
}
struct jf_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__>::type>::type
    operator()(const T0__& y,
        ...
        return jf_lpdf(y, xi, omega, a, b, pstream__);
    }
};
template <typename T0__, typename T1__, typename T2__, typename T3__, class RNG>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
jf_rng(const T0__& xi,
           const T1__& omega,
           const T2__& a,
           const T3__& b, RNG& base_rng__, std::ostream* pstream__) {
...
struct jf_rng_functor__ {
    template <typename T0__, typename T1__, typename T2__, typename T3__, class RNG>
        typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__>::type
    operator()(const T0__& xi,
           const T1__& omega,
           const T2__& a,
           const T3__& b, RNG& base_rng__, std::ostream* pstream__) const {
        return jf_rng(xi, omega, a, b, base_rng__, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_jf : public prob_grad {
private:
        int K;
        std::vector<double> yi;
        std::vector<double> si;
public:
    model_jf(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_jf_namespace::model_jf";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        a = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(1.5, a);
        } catch (const std::exception& e) {
        ...
        b = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(1.5, b);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                a = in__.scalar_lb_constrain(1.5, lp__);
            else
                a = in__.scalar_lb_constrain(1.5);
            current_statement_begin__ = 24;
            local_scalar_t__ b;
            (void) b;  // dummy to suppress unused var warning
            if (jacobian__)
                b = in__.scalar_lb_constrain(1.5, lp__);
            else
                b = in__.scalar_lb_constrain(1.5);
            current_statement_begin__ = 25;
            ...
            stan::math::assign(mu, (xi + ((((((omega * 0.5) * (a - b)) * stan::math::sqrt((a + b))) * stan::math::tgamma((a - .5))) * stan::math::tgamma((b - 0.5))) / (stan::math::tgamma(a) * stan::math::tgamma(b)))));
            current_statement_begin__ = 31;
            stan::math::assign(V, (pow(omega, 2) * ((((a + b) / 4) * ((((pow((a - b), 2) + a) + b) - 2) / ((a - 1) * (b - 1)))) - pow((((((0.5 * (a - b)) * stan::math::sqrt((a + b))) * stan::math::tgamma((a - 0.5))) * stan::math::tgamma((b - 0.5))) / (stan::math::tgamma(a) * stan::math::tgamma(b))), 2))));
            ...
            for (int i = 1; i <= K; ++i) {
                ...
                lp_accum__.add(jf_lpdf<propto__>(get_base1(theta, i, "theta", 1), xi, omega, a, b, pstream__));
            }
            ...
            lp_accum__.add(uniform_log<propto__>(a, 0, 200));
            current_statement_begin__ = 42;
            lp_accum__.add(uniform_log<propto__>(b, 0, 200));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_jf_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double a = in__.scalar_lb_constrain(1.5);
        vars__.push_back(a);
        double b = in__.scalar_lb_constrain(1.5);
        vars__.push_back(b);
        ...
        try {
            ...
            stan::math::assign(theta_new, jf_rng(xi, omega, a, b, base_rng__, pstream__));
...
typedef model_jf_namespace::model_jf stan_model;
#endif
